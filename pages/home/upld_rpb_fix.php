...
if(isset($_POST['Upload_Peng'])){
    ...
    for ($row = 2; $row <= $highestRow; ++$row) {
        ...
        if (is_null($id_ihld) || $id_ihld == '') {
            ...
            $query_insert = 'INSERT INTO develop."RPB_REKON" ("ID_IHLD", "PROGRAM", "NILAI_REALISASI", "TAHUN", "KET_MITRA", 
    ...
    ?>
        ...
        setTimeout("location.href='?pages=upld_rpb_fix'", 1000);
        </script>
    <?php
    } else {
...
if (isset($_POST['Batal'])) {
    echo "<script>document.location.href='?pages=d_hem_ihld';</script>";
}
?>
